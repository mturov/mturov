...
| Пет-проект по анализу музыкальных трендов Spotify | Построить отчет и дашборд в Excel по датасету с треками из Spotify | Excel: сводные таблицы, сводбные диаграммы | 
