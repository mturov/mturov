...
### Контакты
- Связаться со мной можно по [почте](mailto:mixail_turov@mail.ru).
...
| Пет-проект по созданию интерактивного дашборда на основе Streamlit и LLM Ollama | Создание интерактивного дашборда с помощью локальной языковой модели Ollama, создающий графики по запросу пользователя | Python, Streamlit, LLM Ollama | [Ссылка](https://github.com/mturov/project_LLM) |
| Пет-проект по анализу музыкальных трендов Spotify | Построить отчет и дашборд в Excel по датасету с треками из Spotify | Excel: сводные таблицы, сводбные диаграммы | [Ссылка](https://github.com/mturov/project_excel) |
...
---
### Пример дашборда (Yandex DataLens)

Дашборд аналитики по продажам продукции: KPI, динамика выручки, геофильтрация по магазинам, статус клиента.

### Главный экран
![Главный экран дашборда в DataLens](yandex_1.png)

![В качестве примера фильтра выбран магазин "Дельта" с товаром "БиоДом".](yandex_2.png)

В качестве примера фильтра выбран магазин "Дельта" с товаром "БиоДом".
### Статистика
